...
foreach($records as $record) {
    ...
    foreach($related_records as $related_record) {
        echo $related_record->getField('StandingRequest::itemCode') . ' ' . $related_record->getField('StandingRequest::quantity') . ' ' .  $related_record->getField('StandingRequest::languageCode') . '<br>';
    }
    echo '<form action="publisher.php" method="POST">
